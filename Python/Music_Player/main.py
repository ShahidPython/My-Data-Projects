...
#button
paly_button = PhotoImage(file=os.path.join(BASE_DIR, "assets", "play.png"))
Button(root, image=paly_button, bg="#0f1a2b", bd=0,command=play_song).place(x=100, y=400)

stop_button = PhotoImage(file=os.path.join(BASE_DIR, "assets", "stop.png"))
Button(root, image=stop_button, bg="#0f1a2b", bd=0,command=mixer.music.stop).place(x=30, y=500)

resume_button = PhotoImage(file=os.path.join(BASE_DIR, "assets", "resume.png"))
Button(root, image=resume_button, bg="#0f1a2b", bd=0,command=mixer.music.unpause).place(x=115, y=500)

pause_button = PhotoImage(file=os.path.join(BASE_DIR, "assets", "pause.png"))
...
# music
Menu = PhotoImage(file=os.path.join(BASE_DIR, "assets", "menu.png"))
