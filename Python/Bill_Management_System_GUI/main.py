...
def login():
    ...
    if user == "Python" and code == "1234":
        ...
        entry_pastery = Entry(f1,font=("arial",20,"bold"),textvariable=pastery,bd=6,width=8,bg= "lightpink")
    ...
    elif user != "Python" and code != "1234":
...
def main_screen():
    ...
    # icon
    image_icon = PhotoImage(file=os.path.join(os.path.dirname(os.path.abspath(__file__)), "assets", "login.png"))
    ...
    Label(mainframe, text = "Username", font = ("arial", 30), bg = "#d7dae2").place(x= 100, y= 50)
    Label(mainframe, text = "Password", font = ("arial", 30), bg = "#d7dae2").place(x= 100, y= 150)
