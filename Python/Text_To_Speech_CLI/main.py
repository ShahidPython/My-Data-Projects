...
# icon
image_icon = PhotoImage(file=os.path.join(BASE_DIR, "assets", "speak.png"))
...
Logo = PhotoImage(file=os.path.join(BASE_DIR, "assets", "speaker logo.png"))
...
imageicon = PhotoImage(file=os.path.join(BASE_DIR, "assets", "speak.png"))
btn = Button(root,text = "Speak",compound=LEFT,image = imageicon,width = 130, font = "arial 14 bold",command = speaknow)
btn.place(x = 550, y = 280)

imageicon2 = PhotoImage(file=os.path.join(BASE_DIR, "assets", "download.png"))
